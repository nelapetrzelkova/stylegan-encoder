...
def main():
    ...
    parser.add_argument('--model_url', default='https://drive.google.com/uc?id=19B138TWKeOs-JIol0_K-CCCDMYXbK5bk', help='Fetch a StyleGAN model to train on from this URL') # karras2019stylegan-ffhq-1024x1024.pkl
